        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 address-wrap">
                    ...
                    <div class="ihs-logo"><a href="https://www.bc.edu/bc-web/jesuit-catholic.html"><img alt="The Society of Jesus (Jesuits) logo" src="<?= img('ihs-logo.svg'); ?>"/></a></div>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 social-wrap">
                    <div id="socialmedia" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <ul>
                            ...
                            <li><a href="https://www.facebook.com/bostoncollegelibraries" title="Boston College Library Facebook" class="" id="media_facebook"><span class="accessibility-text">Facebook</span></a></li>
                            ...
                            <li><a href="https://twitter.com/bclibraries" title="Follow the Boston College Libraries on Twitter" class="" id="media_twitter"><span class="accessibility-text">Twitter</span></a></li>
                            ...
                            <li><a href="https://www.instagram.com/bclibraries/" title="Boston College Library on Instagram" class="" id="media_instagram"><span class="accessibility-text">Instagram</span></a></li>
                        </ul>
                    </div>
                    ...
                    <div class="quick-links col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <h4>Quick Links</h4>
                        <ul>
                            <li><a href="https://libcal.bc.edu/booking/oneill">Study Rooms</a></li>
                            ...
                            <li><a href="https://arc.bc.edu/reserves">Course Reserves</a></li>
                            <li><a href="https://libguides.bc.edu/refworks-login">RefWorks</a></li>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 hours-wrap">
                    ...
                    <div class="table-hours">
                        <table class="table table-condensed table-bordered">
                            ...
                            <tr>
                                <td><a href="https://www.bc.edu/bc-web/schools/law/sites/current-students/library/using/hours.html">Law Library</a></td>
